...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Acme|Bangers|Caveat:400,700|Economica|Handlee|Kanit|Orbitron" rel="stylesheet">
    ...
    <div class=content>
        <div class="wrapper-1">
            <div class="wrapper-2">
                ...
                <button onclick="window.location='index.html'" id="back-home" class="go-home">
                    go home
                </button>
            </div>
        </div>
