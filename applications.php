        ...
        <div id="resumes" class="row">
            <?php
                ...
                if ($result->num_rows > 0) {
                    ...
                    '<li class="col-md-6" ' . 'onclick=' . 'getResume(' . '"' . $row["email"] . '"' . ')' . '>' . '<span>' . "View resume: " . '</span>' . '<a class="download" target="_blank" href="download.php?fullname=' . $row["fullname"] . '" >' . $row["resume"] . '</a></li>' .
